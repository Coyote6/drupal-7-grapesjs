jQueryLoaded = function (url, callback) {

  // Exit if jQuery is loaded.
...
jQueryLoaded ('https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js', function(){
  responsiveResize(jQuery);
});
